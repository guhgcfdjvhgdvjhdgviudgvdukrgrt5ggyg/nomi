...
val generateObfConstants = tasks.register("generateObfConstants") {
    ...
    doLast {
        ...
        val seed = "nomitype_obf_v1::$pkgName::$sha".toByteArray(Charsets.UTF_8)
...
android {
    namespace = "com.nomitype"
    compileSdk = 34
    ndkVersion = "27.0.12077973"

    defaultConfig {
        applicationId = "com.nomitype"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.12"
