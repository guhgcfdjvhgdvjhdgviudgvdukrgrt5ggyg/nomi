...
import com.nomitype.R
import com.nomitype.data.db.AppDatabase
import com.nomitype.ime.FloatingPointerService
import com.nomitype.data.db.ClipboardItem
import com.nomitype.utils.BuiltInFonts
import com.nomitype.utils.FontManager
import com.nomitype.utils.FontEntry
import com.nomitype.utils.SettingsStore
import com.nomitype.utils.ThemeManager
...
class KeyboardView(
            ...
            row.forEach { key ->
                ...
                val tv = TextView(context).apply {
                    val display = when {
                        ...
                        key.type == KeyType.SPACE -> com.nomitype.security.Obf
                            .decode(context, com.nomitype.security.ObfConstants.SPACE_LABEL)
                            .ifBlank { " " }
    ...
    private fun showClipItemMenu(
        item: ClipboardItem,
        dao: com.nomitype.data.db.ClipboardDao,
        ...
        action("Copy to clipboard") {
            ...
            com.nomitype.utils.ClipboardWatcher.suppressNext(item.text)
            cm.setPrimaryClip(android.content.ClipData.newPlainText("nomitype", item.text))
