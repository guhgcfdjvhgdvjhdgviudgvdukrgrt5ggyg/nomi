...
class FloatingPointerService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START            = "com.nomitype.pointer.START"
        const val ACTION_SHOW_ONLY        = "com.nomitype.pointer.SHOW_ONLY"
        const val ACTION_LOCK             = "com.nomitype.pointer.LOCK"
        const val ACTION_UNLOCK           = "com.nomitype.pointer.UNLOCK"
        const val ACTION_REFRESH          = "com.nomitype.pointer.REFRESH"
        const val ACTION_RESIZE           = "com.nomitype.pointer.RESIZE"
        const val ACTION_AUTO_CLICK_START = "com.nomitype.pointer.AUTO_CLICK_START"
        const val ACTION_AUTO_CLICK_STOP  = "com.nomitype.pointer.AUTO_CLICK_STOP"
