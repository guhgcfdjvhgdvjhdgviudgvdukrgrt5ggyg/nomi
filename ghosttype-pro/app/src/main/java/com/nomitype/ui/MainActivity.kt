...
import com.nomitype.ui.screens.*
import com.nomitype.ui.theme.GhostTypeTheme
                        ...
                        onStartAutoType = {
                            safeLaunch {
                                ...
                                AutoTypeEngine.start(
                                    this,
                                    com.nomitype.utils.SettingsStore.prefs(this)
                                        .getInt(com.nomitype.utils.SettingsStore.KEY_AT_START_LINE, 0)
                                )
...
fun AppRoot(
    ...
    val prefs = com.nomitype.utils.SettingsStore.prefs(ctx)
    var tasksUnlocked by remember {
        mutableStateOf(prefs.getBoolean(com.nomitype.utils.SettingsStore.KEY_TASKS_UNLOCKED, false))
    }
    if (!tasksUnlocked) {
        com.nomitype.ui.screens.TasksDialog(onUnlocked = { tasksUnlocked = true })
    }
        ...
        drawerContent = {
            ModalDrawerSheet(
                ...
                Column(
                    ...
                    val prefs = com.nomitype.utils.SettingsStore.prefs(LocalContext.current)
                    var uiTheme by remember { mutableStateOf(prefs.getString(com.nomitype.utils.SettingsStore.KEY_UI_THEME, "dark") ?: "dark") }
                    ...
                    Row(
                        ...
                        TextButton(
                            onClick = {
                                uiTheme = "dark"
                                prefs.edit().putString(com.nomitype.utils.SettingsStore.KEY_UI_THEME, "dark").apply()
                            },
                        ...
                        TextButton(
                            onClick = {
                                uiTheme = "light"
                                prefs.edit().putString(com.nomitype.utils.SettingsStore.KEY_UI_THEME, "light").apply()
                            },
                            shape = androidx.compose.foundation.shape.RoundedCornerShape(8.dp),
                            colors = ButtonDefaults.textButtonColors(
                ...
                Text(
                    "v${com.nomitype.BuildConfig.VERSION_NAME}",
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    style = MaterialTheme.typography.labelSmall,
        ...
        Scaffold(
            ...
            Box(
                ...
                when (selected) {
                    ...
                    3 -> PointerScreen()
                    4 -> ClipboardScreen()
                    5 -> com.nomitype.ui.screens.FYTScreen()
                    6 -> com.nomitype.ui.screens.MathScreen()
                    7 -> ResetScreen()
                    8 -> com.nomitype.ui.screens.DeveloperScreen()
                    9 -> AboutScreen()
                }
            }
        }
